...
architecture a of SCOMP is
	type state_type is (
		...
		ex_loadi, ex_add, ex_addi, ex_sub, -- ADDED ex_sub
		ex_and, ex_or, ex_xor, ex_shift,
		ex_jump, ex_jneg, ex_jzero, ex_jpos, ex_jnz, -- ADDED ex_jpos, ex_jnz
		ex_return, ex_call,
			...
			case state is
				...
				when decode =>
					...
					case mem_data(15 downto 11) is -- opcode is top 5 bits of instruction
						...
						when "01100"  =>        -- jneg
							state <= ex_jneg;
						when "01101"  =>        -- jpos (ADDED LOGIC)
							state <= ex_jpos;
						when "01110"  =>        -- jzero
							state <= ex_jzero;
						when "01111"  =>        -- jnz (ADDED LOGIC)
							state <= ex_jnz;
						when "10000"  =>        -- call
							state <= ex_call;
						when "10001"  =>        -- return
				...
				-- ADDED: JPOS Execution State
				when ex_jpos =>
					-- Ensure sign bit (15) is 0 AND the number is not exactly zero
